...
{    
    class Numaralar
    {
        ...
        public string KulGenel()
        {
            try
            {
                var numara =(from s in _db.bgKullanicilars orderby s.Id descending select s).First().GenelNo;//descending: azalan demek..
        ...
        public string UrunKodu()
        {
            try
            {
                var numara = (from s in _db.stStokDurums orderby s.Id descending select s).First().UrunKodu;
